...
If you have `weblogo` installed and in your system search path,
running `plot(eg.swarmset)` will make a logo plot to summarize variant
frequency per site in the selected set.  The return value of this
function is a fully-qualified path to the output file name.  Note that
when the R session terminates, this file may be deleted.
